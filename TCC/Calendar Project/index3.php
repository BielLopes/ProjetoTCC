...
<ul class="w3-navbar w3-card-2 w3-black">
  <li><a href="#" class="w3-grey"><img src="imagens/home.png" style="width:19px;margin-bottom:-2px;"> Página Principal</a></li>
...
if(empty($_REQUEST['tipo'])){}else{
	...
	if($senha == $row['senha']){
		...
		echo "Nome de Usuario não existe!";
		}
	}
}
}
...
while($row = mysqli_fetch_array($rs)){
    ...
    echo "<span>Professor: ".$row['prof']."<br/> Escola: ".$row['esc']."</span>";
  echo"</li>";
	}	
}else{
